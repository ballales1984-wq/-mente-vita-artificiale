...
def ciclo_cognitivo_continuo(num_cicli=10, delay=2.0):
    """
    Esegue cicli cognitivi continui
    ...
    """
    print("="*70)
    print("🔄 MENTE ARTIFICIALE - MODALITÀ CICLI CONTINUI")
    print("="*70)
    ...
    try:
        while True:
            ...
            # 1. PERCEZIONE VISIVA
            # ========================================
            print("👁️  [1/6] VISIONE: Elaborazione...")

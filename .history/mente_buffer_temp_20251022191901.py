...
class MenteBufferTemp:
    ...
    def __init__(self, usa_camera=True, usa_mic=True):
        ...
        self.emozione.inizializza()  # Inizializza amigdala
    ...
    def ciclo(self):
        ...
        # Emozione
        print("\n[4/6] ❤️  EMOZIONE")
        stato = self.emozione.elabora(vis['oggetti'], {})
        ...
        # Azione
        print("\n[6/6] 🦾 AZIONE")
        ris = self.motoria.esegui(dec.get('azione', 'monitora'))
        print(f"       {'✅' if ris.dati.get('successo') else '❌'}")
